//
//  MaterialFilledTonalButton.swift
...
struct MaterialFilledTonalButtonStyle: ButtonStyle {
        ...
        return configuration.label.padding(.horizontal, horizontalPadding)
            ...
            .background(
                GeometryReader { geometry in
                    ZStack {
                        Capsule().fill(MaterialTheme.Colors.primaryContainer)
...
struct MaterialFilledTonalButton<Content>: View where Content: View {
    ...
    var body: some View {
        ...
        }.buttonStyle(MaterialFilledTonalButtonStyle(size: size, action: action))

    }
}

struct MaterialFilledTonalButton_Previews: PreviewProvider {
    static var previews: some View {
        VStack {
            MaterialFilledTonalButton(size: .small, action: {}) {
                Text("Test Button")
            }
            MaterialFilledTonalButton(size: .large, action: {}) {
                Text("Test Button")
            }
            MaterialFilledTonalButton(size: .extraLarge, action: {}) {
                Text("Test Button")
            }
        }
    }
