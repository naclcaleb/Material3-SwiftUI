...
struct MaterialFlatFABButtonStyle: ButtonStyle {
...
struct MaterialFlatFABButton: View {
    var icon: String
    ...
    var body: some View {
        Button(action: action) {
            Image(icon)
        }.buttonStyle(MaterialFlatFABButtonStyle(size: size, action: action))

    }
}

struct MaterialFlatFABButton_Previews: PreviewProvider {
    static var previews: some View {
        VStack {
            MaterialFlatFABButton(icon: "CloseIcon", size: .small, action: {})
            MaterialFlatFABButton(icon: "CloseIcon", size: .large)
            MaterialFlatFABButton(icon: "CloseIcon", size: .extraLarge, action: {})
        }
    }
}
